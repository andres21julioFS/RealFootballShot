...
public class StraightXZDragPathDOTS
{
    ...
    public static void getXZV0(ref GetPassV0Element data,ref PathComponent pathComponent,float t,Vector3 Pos0,Vector3 Posf,float maxKickForce)
    {
        ...
        if (data.result.maximumControlSpeedReached || data.result.maxKickForceReached)
        {
            ...
            pathComponent.currentPath.v0Magnitude = data.result.v0Magnitude;
